      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">Administra fichas, historiales y búsqueda avanzada</p>
          </div>
        ...
        {filteredPatients.length === 0 && (
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-gray-600 mb-4">Intenta con otros términos de búsqueda o agrega un nuevo paciente</p>
              <Link href="/patients/new">
